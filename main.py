...
x_data = pd.read_csv("../train_X.csv", index_col=0, sep=',')[0:100]
y_data = pd.read_csv("../train_y.csv", index_col=0, sep=',')[0:100]

x_train, x_valid, y_train, y_valid = sklearn.model_selection.train_test_split(x_data, y_data)

x_test = pd.read_csv("../test_X.csv", index_col=0, sep=',')[0:100]
...
res_df = pd.DataFrame(res, columns=y_data.columns, dtype=int)
